    ...
    <div className="flex-1 min-h-[900px] bg-amber/10 relative">
      ...
      <div className=" absolute inset-0 bg-black/35">
        <div className="absolute inset-0 z-10 w-full h-full section-py-one">
          <div className="section-max-w mx-auto section-px-one h-full flex justify-center ">
            <div className="space-y-12 w-full">
              <div className="space-y-4 text-center">
                ...
                <p className="text-background subtitle-one">
                  Sign in to your Honey Man Ghana account
                </p>
              </div>
              ...
              <div className="bg-background p-8 rounded-2xl shadow-lg w-full max-w-md mx-auto space-y-6 ">
                ...
                <form className="space-y-4">
                  ...
                  <motion.button
                    ...
                    className="block text-center bg-gold text-base text-bold text-cream cursor-pointer w-full px-6 py-3 rounded-lg"
                  >
                    Sign In
                  </motion.button>
